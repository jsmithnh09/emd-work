...
@testset "mean/amplitude" begin
    ...
    @test isapprox(μ, [-0.229287791, 0.149086738, -0.312136628, -1.447260215, -1.959665698, -1.422545880, -0.568859012, 0.064862925, 0.410450924, 0.494524758], rtol=1e-3)
    @test nextr == 6
    @test nzer == 6
    @test isapprox(amp, [3.770712209, 2.850913262, 1.687863372, 1.447260215, 2.040334302, 2.422545880, 2.431140988, 2.420602191, 2.455464774, 2.505475242], rtol=1e-3)
end
